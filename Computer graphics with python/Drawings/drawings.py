...
image = pygame.image.load('avator.jpg')
imagex = 360
imagey = 260
direction = 'left'
...
text_surface_obj = font_obj.render("Hellow World!", True, green, blue)
...
while True: # the main game loop
    ...
    pygame.draw.polygon(screen, green, ((146,0),(291, 106), (236, 277), (56, 277), (0,206) ))
